...
namespace OPCAE.OPCAE.NET
{
    ...
    public class EventSubscriptionMgt0 : IOPCEventSink
    {
        ...
        //private OPCConditionState opcCondState;

        private event OnAEeventHandler ClientHandler;

        public EventSubscriptionMgt0(OnAEeventHandler clh)
        {
